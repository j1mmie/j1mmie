...
Learnings:
  ...
  3. Currently trying to figure out what about tilemap.SetTile is causing this. SetTile is being called with SuperTile objects, which are ScriptableObjects. I've disabled all Sprites and Animators on SuperTile. Result:
