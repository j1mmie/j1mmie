...
1. Auth server - New User creation code that includes new credit and respec token balances
2. unlockCrewmate Function - New non-nullable EquippedSkin

Follow-up migrations:

1. Backfill User inventories to include credits and respec tokens
2. Backfill Crew to have EquippedSkin even if they haven't equipped one

Gamelift deploy:

1. Deploy new code that removes old client checksum from legacy list
