...
TODO: ShipTechLevelChanged should include latest gem economy changes

9:37pm

Regression test looks good. Good enough for deploy. Merging this work into main and deploying

- [ ] Deploy new code
- [ ] Run migrations (`npm run migrations:production:migrate:dry`)
