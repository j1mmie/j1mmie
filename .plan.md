...
Google Play Games signin issue
SHA1 fingerprint does not match OAuth2 credential
Can be tested via `adb logcat | grep -i PlayGames`

```
05-20 21:07:25.658 25155  7997 E PlayGamesServices[SignInAuthenticator]: **** To help you debug, here is the information about this app
05-20 21:07:25.658 25155  7997 E PlayGamesServices[SignInAuthenticator]: **** Package name         : net.subpixel.Slipstream
05-20 21:07:25.658 25155  7997 E PlayGamesServices[SignInAuthenticator]: **** Cert SHA1 fingerprint: FA:3D:1C:8B:96:8B:B3:E0:68:04:6B:17:29:F4:B2:92:8F:29:AB:67
05-20 21:07:25.658 25155  7997 E PlayGamesServices[SignInAuthenticator]: **** App ID from manifest : 1070641667986
```

Solution:

Need two client IDs, one for debug/dev, one when auto-signed by Play Games

Can be added here:
https://console.cloud.google.com/apis/credentials/oauthclient/1070641667986-u00n6tlufaoj5d4m50e6rsu7nuj6vc4r.apps.googleusercontent.com?project=subpixel-slipstream-prod

App might need to choose dynamically which client id to use based on dev / production release?
