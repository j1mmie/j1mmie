...
This morning I made a diagram to help communicate the game's front-end architecture a bit more. 1. Because Alfredo will do some of the work for simulating a game-server locally (more on that later), and 2. Because in one of his PR's I noticed some concern-crossing, and realized I never quite explained the design goals of the game's architecture. It was written about in some of the on-boarding documentation, but never visualized. Here's the diagram:
