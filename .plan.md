...
Learnings:
  ...
  2. Using "TilesAsObjects" probably solves the problem, but path walking doesn't work. Maybe I should just give that a shot though as a test.
  3. Currently trying to figure out what about tilemap.SetTile is causing this. SetTile is being called with SuperTile objects, which are ScriptableObjects.
  ...
  5. One solution might just be to make ships Resources, not addressables.