...
TODO:
 - Migrations need to be run in prod, which will create the `crewSkins` table. This should have no effect on the old clients in production
 - Two new endpoints need to be deployed. They can be deployed independently of everything else:
   - `unlockCrewSkin`
   - `equipCrewSkin`
 -